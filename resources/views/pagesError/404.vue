<template>
    <div class="flex">
        <NavbarAll />
        <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900 border-t">
            <div class="block md:max-w-lg">
                <img  :src="notfoundimage" alt="astronaut image" class="h-[400px]">
            </div>
            <div class="text-center xl:max-w-4xl">
                ...
                <a href="/login" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
...
import NavbarAll from '../layouts/NavbarAll.vue'
