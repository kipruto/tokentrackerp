...
<div class="card shadow-sm mt-6">
    ...
    <div class="card-body grid grid-cols-2 gap-6 lg:grid-cols-1">
        ...
        <div class="p-8">
            <h1 class="h2">53%</h1>
            <p class="text-black font-medium">Tasks Completed this month</p>

            <div class="mt-20 mb-2 flex items-center">
                <div class="py-1 px-3 rounded bg-green-200 text-green-900 mr-3">
                    <i class="fa fa-caret-up"></i>
                </div>
                <p class="text-black"><span class="num-2 text-green-400"></span><span class="text-green-400">4% more tasks completed</span> in comparison to last month.</p>
            </div>
