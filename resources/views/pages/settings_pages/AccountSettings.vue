    ...
    <div class="bg-white flex">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-5">
          ...
          <div class="flex items-center">
            <div class="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3 w-1/5">
              ...
              <label for="login-password">
                <div class="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-blue-600 mt-3">
          ...
          <p class="mt-2">Can't remember your current password. <a class="text-sm font-semibold text-blue-600 underline decoration-2" href="#">Reset</a></p>
          <button class="mt-4 rounded-lg bg-blue-600 px-4 py-2 text-white">Save New Password</button>
          <hr class="mt-4 mb-8" />
...
export default {
  ...
  mounted() {
    console.log('General Settings component mounted');
  },
